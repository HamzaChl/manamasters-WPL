  ...
  try {
    ...
    while (i < cardHolder.length) {
      ...
      if (data.cards[random].imageUrl && data.cards[random].name) {
        ...
        cardName[i].innerHTML = `${data.cards[random].name} <span class="rarity">${rarityLetter}</span>`;
        ...
        if (data.cards[random].rarity === "Uncommon") {
          ...
          cardIMG[i].style.boxShadow = "0px 2px 6px 5px rgba(255, 255, 255, 0.5)";
          cardIMG[i].style.outline = "1px solid rgb(255, 255, 255)";
        } else if (data.cards[random].rarity === "Rare") {
          cardIMG[i].style.boxShadow = "0px 2px 6px 5px rgba(174, 186, 85, 0.5)";
